...
\usepackage{garamondx}                      % Enable bold garamond, smallcaps
\usepackage{multicol}                       % add multi-column support
...
\input{pii.tex}                             % insert personally identifiable information (name, address, etc.)
...
\cventry{04/2009--12/2009}{Operations Engineer - Tier II}
{Avanade}{Seattle WA}{}{}
