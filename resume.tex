...
\cvitem{Devstation}{%
  A Chef cookbook for setting up my personal development environment.
  Provides configuration management and quick rebuild of a Linux development
  environment on Ubuntu as needed.\\
