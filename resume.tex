...
\cvitem{Devstation}{%
  An opinionated Chef cookbook for setting up a personal development
  environment.  Provides configuration management and quick rebuild of a Linux
  development environment on Ubuntu.\\
  \textit{Uses: Ruby, Chef, Bash}
}
\cvitem{Double-Shot}{%
...
\cvitem{WinDHCP}{%
  A Chef library cookbook exposing resources and providers for use in recipes,
  using the DHCP Server API and Ruby FFI to allow configuration of
  Windows-based DHCP servers.\\
  \textit{Uses: Ruby, Chef}
}
