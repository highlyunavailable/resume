...
\cvitem{WinDHCP}{%
  A library cookbook providing resources for Windows Server DHCP services APIs
  via a Chef LWRP. Uses custom Ruby code with the Ruby FFI gem to natively
  access the Windows DHCPSAPI library.\\
  \textit{Uses: Ruby, Chef, FFI}
}
\cvitem{Double-Shot}{%
  A web application to tag, organize, search and display images.\\
  \textit{Uses: Node.js, PostgreSQL, React.js}
}

\section{\textsc{Technical Skills}}
\cvitem{Languages}{PowerShell, Ruby, C\#, SQL, JavaScript, XML, HTML, CSS}
\cvitem{Automation}{Chef, Orchestrator 2012}
...
\cvitem{Identity Management}{Forefront Identity Manager, ADFS, Active Directory}
